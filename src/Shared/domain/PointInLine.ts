...
export default class PointInLine extends Point {
    ...
    public constructor(longitude: Longitude, latitude: Latitude, positionInLine: number) {
    ...
    public static create(stringPoint: string, positionInLine: number): PointInLine {
